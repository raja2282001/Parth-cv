...
export function PortfolioSection() {
  ...
  const projects = [
    ...
    },
    {
      id: 3,
      title: 'iVogue',
      description: 'A mobile platform built with Next.js, specializing in the sale of stylish and durable mobile covers. Offers a seamless browsing experience with fast performance and responsive design for easy navigation and secure purchasing.',
      tags: ['Next.js', 'E-commerce', 'Mobile Covers', 'Responsive'],
      link: 'https://ivogue.store/',
      github: '#',
      image: '/projects/ivogue.jpg',
    },
    {
      id: 4,
      title: 'JKSwara',
      description: 'An e-commerce website built with React, offering a smooth and interactive shopping experience. Provides a wide range of products with fast load times, responsive design, and secure online transactions.',
      tags: ['React', 'E-commerce', 'Interactive UI', 'Shopping'],
      link: 'https://jk-frontend.onrender.com/',
      github: '#',
      image: '/projects/jkswara.jpg',
    },
    {
      id: 5,
      title: 'INDUSTRIAL',
    ...
    },
    {
      id: 10,
      title: 'TextUtils',
      description: 'A React-based web application designed to assist users in managing and manipulating text content. Offers features for word counting, character counting, and removing extra spaces. Perfect for writers, editors, and anyone needing to analyze and clean up text.',
      tags: ['React', 'Utility App', 'Text Processing', 'JavaScript'],
      link: 'https://raja2282001.github.io/textutils/',
      github: '#',
    ...
    {
      id: 12,
      title: 'll_Ig_Lucifer_ll (Gaming)',
      description: 'A gaming content platform created by RDX Lucifer, a passionate gamer and skilled video editor. Showcases diverse gaming content from action-packed shooters to immersive role-playing adventures with unique insights and entertaining gameplay experiences.',
      tags: ['Gaming', 'Content', 'Video Editing', 'Community'],
      link: 'https://rdx-gaming.onrender.com/',
      github: '#',
    ...
    },
    {
      id: 13,
      title: 'LEARNVE',
      description: 'Online learning platform similar to Udemy for accessing educational courses with video-based learning and seamless course navigation. Provides a comprehensive learning experience with structured courses and interactive content.',
